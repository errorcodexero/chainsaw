...
struct Auto_gearloading_topeg : public Executive_impl<Auto_gearloading_topeg>{
	...
	Auto_gearloading_topeg(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
...
struct Auto_gearloading_turn : public Executive_impl<Auto_gearloading_turn>{
	...
	Auto_gearloading_turn(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
...
struct Auto_gearloading_approach: public Executive_impl<Auto_gearloading_approach>{
	...
	Auto_gearloading_approach(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
...
struct Auto_gearloading_geardrop : public Executive_impl<Auto_gearloading_geardrop>{
	...
	Auto_gearloading_geardrop(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}	
