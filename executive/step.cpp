...
const double RIGHT_SPEED_CORRECTION = 0.0;//left and right sides of the robot drive at different speeds given the same power, adjust this to make the robot drive straight
