...
struct Auto_gearboilerext_frompeg : public Executive_impl<Auto_gearboilerext_frompeg>{
	...
	Auto_gearboilerext_frompeg(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
	Auto_gearboilerext_frompeg(Drivebase::Encoder_ticks initial_encoders1):initial_encoders(initial_encoders1){}
...
struct Auto_gearboilerext_turn : public Executive_impl<Auto_gearboilerext_turn>{
	...
	Auto_gearboilerext_turn(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
...
struct Auto_gearboilerext_driveone: public Executive_impl<Auto_gearboilerext_driveone>{
	...
	Auto_gearboilerext_driveone(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
...
struct Auto_gearboilerext_turntwo: public Executive_impl<Auto_gearboilerext_turntwo>{
	...
	Auto_gearboilerext_turntwo(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
...
struct Auto_gearboilerext_drivetwo: public Executive_impl<Auto_gearboilerext_drivetwo>{
	...
	Auto_gearboilerext_drivetwo(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){} 
