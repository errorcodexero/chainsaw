...
struct Auto_gearboiler_topeg : public Executive_impl<Auto_gearboiler_topeg>{
	...
	Auto_gearboiler_topeg(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
...
struct Auto_gearboiler_turn : public Executive_impl<Auto_gearboiler_turn>{
	...
	Auto_gearboiler_turn(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
...
struct Auto_gearboiler_approach: public Executive_impl<Auto_gearboiler_approach>{
	...
	Auto_gearboiler_approach(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}
...
struct Auto_gearboiler_geardrop : public Executive_impl<Auto_gearboiler_geardrop>{
	...
	Auto_gearboiler_geardrop(unsigned gear_step1, Drivebase::Encoder_ticks initial_encoders1):gear_step(gear_step1),initial_encoders(initial_encoders1){}	
